<template>
    <div class="bg-pink text-raisin-black shadow mt-6 py-10 px-4 text-left">
        ...
        <div class="text-xl">
            <p>I spend most of my energy building stuffs with <span class="font-black">Django | Vue.js | React.js</span></p>
            <div class="mt-2">
                <span class="text-2xl font-black">My stack includes the following technologies:</span>
                
                <div class="mt-2" v-for="{title, stack} in stacks">
